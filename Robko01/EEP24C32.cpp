...
#define EEPROM__WR_BUFFER_SIZE    (BUFFER_LENGTH - 2)
	  ...
	  ******************************************************************************/
	  ...
	  /**************************************************************************//**
	   * \fn EEP24C32Class::EEP24C32Class(byte deviceAddress)
	   *
	   * \brief Constructor.
	   *
	   * \param   deviceAddress   EEPROM address on TWI bus.
	   ******************************************************************************/
EEP24C32Class::EEP24C32Class
(
	byte deviceAddress
) {
...
/**************************************************************************//**
 * \fn void EEP24C32Class::initialize()
 *
 ...
 ******************************************************************************/
void
EEP24C32Class::initialize()
{
	Wire.begin();
}

/**************************************************************************//**
 * \fn void EEP24C32Class::writeByte(
 * word address,
 * byte data)
 *
...
/**************************************************************************//**
 * \fn void EEP24C32Class::writeBytes(
 * word     address,
 * word     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn byte EEP24C32Class::readByte(word address)
 *
...
/**************************************************************************//**
 * \fn void EEP24C32Class::readBytes(
 * word     address,
 * word     length,
 * byte*    p_data)
 *
 ...
 ******************************************************************************/
 ...
 /**************************************************************************//**
  * \fn void EEP24C32Class::writePage(
  * word     address,
  * byte     length,
  * byte*    p_data)
  *
...
/**************************************************************************//**
 * \fn void EEP24C32Class::writeBuffer(
 * word     address,
 * byte     length,
 * byte*    p_data)
 *
...
/**************************************************************************//**
 * \fn void EEP24C32Class::readBuffer(
 * word     address,
 * byte     length,
 * byte*    p_data)
 *
